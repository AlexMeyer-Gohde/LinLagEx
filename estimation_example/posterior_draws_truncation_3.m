%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%posterior_draws_truncation_3.m
%
%This program:
...
%               truncated model
%
%      NOTE: The file posterior_mode_truncation_3.mat, containing the
...
%      the file posterior_mode_truncation_3 first.
%
%       Simply change to the directory where this file is located, type
%       posterior_draws_truncation_3, wait a couple of hours, and the results will be 
%       displayed and then saved in the file
%       mixed_posteriors_truncation_3.mat
%
%
...
save_final_name='mixed_posteriors_truncation_3';
...
draw_type=0;
save_name='posterior_truncation_3_draw_1';
...
eval(sprintf('eval([''save_name=''''posterior_truncation_3_draw_%s'''';''])', num2str(j)))
[results,draws,results_densities,lagged_expectations]=metropolis_hastings(mode_estimate_data, draw_type, number_of_draws, burn_in, overdispersion,save_name);
