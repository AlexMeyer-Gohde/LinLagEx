%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%input_example_me_bayesian_correlations_truncation_3.m
%
%This program:
%               is the model file used for calculating posterior
%               correlations and impulses in the truncated model.
%
%           The only difference to
%           input_example_me_3.m is in the options: we want to calculate
